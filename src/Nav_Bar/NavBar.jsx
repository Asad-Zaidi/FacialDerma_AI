                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-14">
                        ...
                        <NavLink
                            ...
                            onClick={closeMenu}
                        >
                            <div className="w-8 h-8 bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                <BsShieldCheck className="text-white text-base" />
                            </div>
                            <div className="hidden sm:block">
                                <h1 className="text-base font-bold bg-gradient-to-r from-gray-800 to-gray-900 bg-clip-text text-transparent leading-tight">
                                    FacialDerma
                                </h1>
                                <p className="text-[10px] text-gray-500 font-medium -mt-0.5">AI-Powered</p>
                            </div>
                        </NavLink>
                            ...
                            {isLoggedIn ? (
                                <>
                                    ...
                                    <li className="relative">
                                        <button
                                            onClick={toggleNotifications}
                                            className="relative flex items-center justify-center w-8 h-8 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-all duration-200"
                                        >
                                    ...
                                    <li>
                                        <button
                                            onClick={() => setShowConfirmSignOut(true)}
                                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition-all duration-200"
                                        >
                                            <FaSignOutAlt className="text-sm" />
                                            <span>Logout</span>
                                        </button>
                                ...
                                <li>
                                    <NavLink
                                        to="/Login"
                                        className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg font-semibold text-sm bg-gradient-to-r from-gray-800 to-gray-900 text-white hover:from-gray-900 hover:to-black shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                                    >
                        ...
                        <button
                            onClick={toggleMenu}
                            className="md:hidden w-8 h-8 flex items-center justify-center text-gray-700 hover:bg-gray-100 rounded-lg transition-all duration-200"
                            aria-label="Toggle menu"
                        >
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-4 border-b border-gray-200">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-lg flex items-center justify-center shadow-md">
                                    <BsShieldCheck className="text-white text-base" />
                                </div>
                                <div>
                                    <h2 className="text-base font-bold bg-gradient-to-r from-gray-800 to-gray-900 bg-clip-text text-transparent">
                                        FacialDerma
                                    </h2>
                        ...
                        {/* Mobile Menu Items */}
                        <ul className="p-3 space-y-1 overflow-y-auto max-h-[calc(100vh-80px)]">
                            <li>
                                <NavLink
                                    to="/"
                                    onClick={closeMenu}
                            ...
                            {isLoggedIn ? (
                                <>
                                    ...
                                    <li>
                                        <button
                                            onClick={toggleNotifications}
                                            className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-all duration-200"
                                        >
                                            <div className="relative">
                                                <FaBell className="text-lg" />
                                                {notificationCount > 0 && (
                                    ...
                                    <li className="pt-2 border-t border-gray-200 mt-2">
                                        <button
                                            ...
                                            className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg font-medium text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition-all duration-200"
                                        >
                                ...
                                <li>
                                    <NavLink
                                        to="/Login"
                                        onClick={closeMenu}
                                        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm bg-gradient-to-r from-gray-800 to-gray-900 text-white hover:from-gray-900 hover:to-black shadow-md hover:shadow-lg transition-all duration-200"
                                    >
                                        <MdLogin className="text-lg" />
                                        <span>Login</span>
                                    </NavLink>
