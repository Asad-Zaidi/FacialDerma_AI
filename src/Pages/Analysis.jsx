...
//         try {
//             const response = await fetch('http://localhost:5000/predictions/predict', {
//                 method: 'POST',
//                 headers: {
...
import suggestionsData from '../Assets/treatmentSuggestions.json';
import { generatePdfReport } from '../components/PdfReportGenerator';
// Import the necessary API function from api.js
        ...
        try {
            ...
            if (error.response) {
                ...
                if (typeof backendError === 'object' && backendError !== null) {
                    // If the error payload is an object (e.g., from validation), 
                    // convert it to a readable string or JSON for debugging.
                    errMsg = JSON.stringify(backendError); 
