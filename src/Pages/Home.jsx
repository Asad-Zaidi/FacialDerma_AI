    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 relative overflow-hidden">
            ...
            <main className="relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 lg:py-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className={`relative transition-all duration-1000 transform delay-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
                            <div className="relative">
                                {/* Decorative Elements */}
                                <div className="absolute -top-4 -right-4 w-72 h-72 bg-gradient-to-br from-gray-300 to-gray-400 rounded-full filter blur-3xl opacity-30 animate-pulse"></div>
                                <div className="absolute -bottom-4 -left-4 w-72 h-72 bg-gradient-to-br from-gray-400 to-gray-500 rounded-full filter blur-3xl opacity-30 animate-pulse animation-delay-2000"></div>
                                ...
                                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-4 md:p-6 border border-gray-200 transform hover:scale-105 transition-transform duration-500">
                                    ...
                                    {/* Processing Time Badge */}
                                    <div className="absolute top-4 right-4 bg-gradient-to-r from-gray-700 to-gray-900 rounded-xl shadow-lg p-2 md:p-3 border border-white animate-float animation-delay-2000">
                                        <div className="flex items-center gap-2 text-white">
                                            <BsClock className="text-base md:text-lg" />
                                            <div className="text-xs md:text-sm font-bold">
                                                <div>Results in</div>
                                                <div className="text-lg md:text-xl">3 sec</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {/* Enhanced Trust Indicators Section */}
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                    <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
                            Trusted by Healthcare Professionals
                        </h2>
                        <p className="text-base md:text-lg opacity-90 mb-8 max-w-3xl mx-auto">
                        ...
                        {!isLoggedIn && (
                            <Link
                                to="/Login"
                                className="inline-flex items-center gap-2 bg-white text-gray-900 font-bold py-4 px-8 rounded-xl text-base md:text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group"
                            >
                                Start Your Free Analysis
                                <span className="transform transition-transform group-hover:translate-x-1">→</span>
                            </Link>
